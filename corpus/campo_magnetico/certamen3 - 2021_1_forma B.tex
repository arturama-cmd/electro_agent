...
%TCIDATA{LastRevised=Friday, July 23, 2021 10:47:21}
...
'QWLOE201.wmf';tempfile-properties "XPR";}}
\end{equation*}

\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textbf{%
Certamen 3 - Electromagnetismo - Forma B}
...
\begin{enumerate}
\item (19 puntos) Un lazo de corriente $I=1,87$ [A] circula en una regi\'{o}%
n de campo magn\'{e}tico uniforme de magnitud $B=500$ [mT], el cu\'{a}l
apunta hacia afuera de la p\'{a}gina, como muestra la Fig. 1. Considere el
sistema de referencia de la Fig. 1 y que la longitud del tramo $ac$ es $%
l_{ac}=18$ [cm]
...
\begin{equation*}
\FRAME{itbpFU}{2.527in}{2.0392in}{0in}{\Qcb{Figura 1}}{}{Figure}{\special%
{language "Scientific Word";type "GRAPHIC";maintain-aspect-ratio
TRUE;display "USEDEF";valid_file "T";width 2.527in;height 2.0392in;depth
0in;original-width 5.0531in;original-height 4.0707in;cropleft "0";croptop
"1";cropright "1";cropbottom "0";tempfilename
'QWLOIO05.bmp';tempfile-properties "XPR";}}
\end{equation*}%
\pagebreak
\end{enumerate}

\item (20 puntos) Por dos cables muy extensos circulan las corrientes $%
I_{1}=500$ [mA] e $I_{2}=1600$ [mA], en las direcciones indicadas en la Fig.
2. En alg\'{u}n instante de tiempo, una carga puntual $q=76,0$ [nC] se mueve
con una rapidez $v=250,0$ [m/s\NEG{]} en una direcci\'{o}n paralela a la
corriente $I_{1}$, donde $x_{1}=13,0$ [cm] e $x_{2}=7,0$ [cm]. En ese
instante de tiempo:
...
\begin{equation*}
\FRAME{itbpFU}{2.6757in}{3.3978in}{0in}{\Qcb{Figura 2}}{}{Figure}{\special%
{language "Scientific Word";type "GRAPHIC";maintain-aspect-ratio
TRUE;display "USEDEF";valid_file "T";width 2.6757in;height 3.3978in;depth
0in;original-width 4.964in;original-height 6.3244in;cropleft "0";croptop
"1";cropright "1";cropbottom "0";tempfilename
'QWLQJO06.bmp';tempfile-properties "XPR";}}
\end{equation*}
\end{enumerate}

\item (20 puntos) Por un solenoide que posee $n=220$ vueltas por metro y un
radio $r=16$ [cm] circula una corriente variable $I(t)=0,4e^{0,08t}$ [A], en
el sentido indicado en la Figura 3. En el centro de \'{e}ste hay un bobina
conductora que posee $N=15$ vueltas, un radio $R=7,5$ [cm] y una resistencia 
$R=21$ [$\Omega $].
...
"1";cropright "1";cropbottom "0";tempfilename
'QWLOE204.wmf';tempfile-properties "XPR";}}
\end{equation*}
\end{enumerate}
\end{enumerate}
