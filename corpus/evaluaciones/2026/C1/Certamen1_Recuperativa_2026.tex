...
%--------------------------------------------------------
% PREGUNTA 1  (Forma Recuperativa: esferas 1B)
%--------------------------------------------------------
\question[20]
...
\noindent$\bullet$~Esfera \textbf{verde}: $q_V=-19{,}0\,\mu$C, en $X=-1{,}00$ cm, $Y=4{,}00$ cm.\\
$\bullet$~Esfera \textbf{azul}: $q_A=198\,\mu$C, en $R=4{,}00$ cm, $\theta=60{,}0^\circ$.\\
$\bullet$~Esfera \textbf{roja}: $q_R=7{,}01\,\mu$C, en $X=2{,}00$ cm, $Y=0$ cm.
\end{minipage}\hfill
\begin{minipage}[t]{0.40\textwidth}
\vspace{0pt}
\centering
\begin{tikzpicture}[scale=0.575, >=Stealth, line width=0.7pt]
    \draw[->,gray] (-2,0)--(4,0) node[right,font=\scriptsize]{$x$ [cm]};
    \draw[->,gray] (0,-0.8)--(0,5) node[above,font=\scriptsize]{$y$ [cm]};
    \node[gray,font=\tiny,below right] at (0,0){$O$};
    \draw[dashed,gray] (0,0)--(2,3.464);
    \draw (1,0) arc (0:60:1);
    \node[font=\tiny] at (1.28,0.6){$60^\circ$};
    \filldraw[green!55!black] (-1,4) circle (6pt);
    \node[green!55!black,above,font=\scriptsize] at (-1,4.5){verde};
    \filldraw[blue] (2,3.464) circle (6pt);
    \node[blue,right,font=\scriptsize] at (2.3,3.464){azul};
    \filldraw[red] (2,0) circle (6pt);
    \node[red,below right,font=\scriptsize] at (2.15,-0.1){roja};
\end{tikzpicture}\\[2pt]
{\footnotesize Fig.\ 1}
\end{minipage}
...
%--------------------------------------------------------
% PREGUNTA 2  (Forma Recuperativa: circulo Version 2)
%--------------------------------------------------------
\question[19]
\begin{minipage}[t]{0.56\textwidth}
\vspace{0pt}
\qhead{19}Considere una circunferencia de radio $25$ cm, en la cual se encuentra un sistema de dos
cargas el\'ectricas, como se muestra en la figura. Las cargas tienen valores $q_1=10\,\mu$C y
$q_2=-5\,\mu$C.
...
\vspace{0pt}
\centering
\includegraphics[width=\textwidth]{fig_q2_v2.png}\\[2pt]
{\footnotesize Fig.\ 2}
\end{minipage}

\vspace{0.4cm}
\noindent\textbf{(b)} Determine el campo el\'ectrico neto generado por el sistema de cargas en el punto
$P_1$, ubicado tambi\'en en la circunferencia como muestra la figura. \pts{7}

\vspace{10cm}
\noindent\textbf{(c)} Determine el campo el\'ectrico neto generado por el sistema de cargas en el punto
$P_2$, ubicado $35$ cm sobre el centro de la circunferencia. \pts{8}

\newpage

%--------------------------------------------------------
% PREGUNTA 3  (Forma Recuperativa: cuarto de anillo + varilla, Version 2)
%--------------------------------------------------------
\question[20]
\begin{minipage}[t]{0.55\textwidth}
\vspace{0pt}
\qhead{20}En el plano $xy$ se tiene un cuarto de anillo de radio $R=0{,}6$ m, centrado en el origen $O$
y ubicado en el primer cuadrante, con densidad de carga lineal uniforme $\lambda_1=-4$ nC/m. Sobre el
eje $+x$, desde $x=R$ hasta $x=4R$, se encuentra una varilla cargada uniformemente, cuya carga total es
$Q_2=7{,}2$ nC. Ambas distribuciones de carga se muestran en la figura. Determine:
...
\begin{tikzpicture}[>=Stealth, thick, scale=0.6]
  ...
  \node[font=\small] at (4.25,0.7){$\lambda_2$};
