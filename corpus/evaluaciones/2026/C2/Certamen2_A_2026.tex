...
\begin{itemize}\setlength\itemsep{1pt}
    \item El \textbf{cilindro interior} es un aislante macizo de radio $R$, con carga total $+2Q$
          distribuida uniformemente en su volumen.
    \item El \textbf{cilindro exterior} es un conductor el\'ectricamente neutro que ocupa la regi\'on
          entre $2R$ y $3R$.
...
\vspace{0pt}
\centering
\includegraphics[width=\textwidth]{figura gauss.png}\\[2pt]
{\footnotesize Fig.\ 1.}
\end{minipage}

\medskip
\noindent\textbf{(a)} Regi\'on $r<R$. \pts{8}

\vspace{5.2cm}
\noindent\textbf{(b)} Regi\'on $R<r<2R$. \pts{6}

\vspace{5cm}
\noindent\textbf{(c)} Regi\'on $2R<r<3R$. \pts{4}
...
%--------------------------------------------------------
% PREGUNTA 2  (P2 version 1 = main1)
%--------------------------------------------------------
\question[17]
\begin{minipage}[t]{0.56\textwidth}
\vspace{0pt}
\qhead{17}Se dispone de un sistema formado por 3 cargas puntuales: $q_1=8$ [nC], $q_2=-25$ [nC] y
$q_3=24$ [nC] ubicadas en los puntos $P_1(4,8,0)$, $P_2(0,4,3)$ y $P_3(4,4,2)$ respectivamente, como muestra la Figura. Si las
...
\begin{tikzpicture}[scale=0.72]
    \draw[step=1cm,very thin, gray!40] (-3,-2) grid (4,6);
    \draw[black, line width =1.1,->, >=latex] (0,0) -- (0,6) node [black, right] {$Y$};
    \draw[black, line width =1.1,->, >=latex] (0,0) -- (4,0) node [black, above] {$X$};
    \draw[black,line width=1.1, ->, >=latex] (0,0) -- (-2.5,-2) node [black, above] at (-2.5,-1.8) {$Z$};
    \node[black, right] at (0,4.3) {$P$};
    \node[black] at (-1.4,-1.5) {$3$};
    \node[black,below] at (2,0) {$4$};
    \fill (2,4) circle (0.16);
    \draw[black, dashed] (2,0) -- (2,4) node[black, xshift=15pt] at (2,4) {$q_1$};
    \draw[black, dashed] (0,4) -- (2,4) node[black, xshift=-10pt] at (0,4) {$8$};
    \fill (0,4) circle (0.16);
    \draw[black, dashed] (-1.3,-1) -- (-1.3,1) node[black, right] at (-1.9,1.5) {$q_2$};
    \draw[black, dashed] (-0.5,1.5) -- (1.5,1.5);
    \draw[black, dashed] (0,2) -- (-1.3,1) node[black, right] at (0,2) {$4$};
    \draw[black, dashed] (0,2) -- (2,2);
    \draw[black, dashed] (1.5,1.5) -- (2,2);
    \draw[black, dashed] (1.5,-0.5) -- (-0.5,-0.5) node[black, right] at (1.5,1) {$q_3$};
    \draw[black, dashed] (2,0) -- (1.5,-0.5);
    \draw[black, dashed] (1.5,-0.5) -- (1.5,1.5);
    \fill (1.5,1.5) circle (0.16);
    \fill (-1.3,1) circle (0.16);
    \draw[black, dashed] (1.5,0) -- (1.5,-0.5) node[black, right] at (-1.3,-0.3) {$2$};
\end{tikzpicture}\\[2pt]
{\footnotesize Fig.\ 2 (posiciones en cm).}
\end{minipage}

\medskip
\noindent\textbf{(a)} Calcule el potencial el\'ectrico en el punto $P(0,8,0)$. \pts{7}

\vspace{6cm}
\noindent\textbf{(b)} Calcule la energ\'ia contenida en el sistema. \pts{7}

\vspace{6.5cm}
\noindent\textbf{(c)} Calcule el trabajo necesario para traer una carga $q_4=-7$ [nC] al punto $P$. \pts{3}

\newpage

%--------------------------------------------------------
% PREGUNTA 3  (P3 version 1 = uniforme v1)
%--------------------------------------------------------
\question[20]
\begin{minipage}[t]{0.56\textwidth}
\vspace{0pt}
\qhead{20}En el plano $xy$ se tiene un arco de circunferencia de radio $R$, centrado en el origen $O$ y
con densidad lineal de carga uniforme $\lambda_0$. A partir del punto del arco que intersecta el eje $x$
se encuentra una barra recta de longitud $2R$, con densidad lineal de carga uniforme $\lambda_1$.
\end{minipage}\hfill
\begin{minipage}[t]{0.40\textwidth}
\vspace{0pt}
\centering
\begin{tikzpicture}[scale=0.92]
    \def\R{1.45}
    \draw[->,thick] (-0.45,0) -- (4.6,0) node[right] {$x$};
    \draw[->,thick] (0,-1.95) -- (0,2.05) node[above] {$y$};
    \fill (0,0) circle (1.2pt);
    \node[below left] at (0,0) {$O$};
    \draw[line width=1.6pt] (0,-\R) arc[start angle=-90, end angle=45, radius=\R];
    \draw[densely dashed] (0,0) -- (45:\R);
    \draw (0.42,0) arc[start angle=0, end angle=45, radius=0.42];
    \node[font=\small] at (0.72,0.24) {$45^\circ$};
    \node[left,font=\small] at (1.0,-0.92) {$\lambda_0$};
    \draw[line width=2.5pt] (\R,0) -- ({3*\R},0);
    \draw (\R,0.11) -- (\R,-0.11);
    \draw ({3*\R},0.11) -- ({3*\R},-0.11);
    \node[above,font=\small] at ({2.05*\R},0.28) {$\lambda_1$};
    \node[left,font=\small] at (0,-1.42) {$R$};
    \draw[<->] (\R,-0.48) -- ({3*\R},-0.48);
